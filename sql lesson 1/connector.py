...
query_select = 'SELECT * FROM "user" WHERE email = %s;'
query_insert = 'INSERT INTO "user"(email) VALUES (%s)'
params = ("asd@gmail.com",)
result = db_connection.execute_query(query_select, params)
print(result)
